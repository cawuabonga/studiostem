...
export function AvailableTeachersList({ teachers }: AvailableTeachersListProps) {
    return (
        <Card>
            <CardHeader>
                <div className="flex items-center gap-2">
                    <UserCheck className="h-6 w-6 text-green-600" />
                    <CardTitle>Docentes con Horas Disponibles ({teachers.length})</CardTitle>
                </div>
                <CardDescription>
                    Listado de docentes con menos de 18 horas semanales asignadas en este período.
                </CardDescription>
            </CardHeader>
                    ...
                    return (
                        <div key={load.teacher.documentId} className="p-3 border rounded-md bg-background flex justify-between items-center">
                            ...
                            <div className="text-right">
                                <span className="font-bold text-lg text-green-600">{load.totalHours}h</span>
                     ...
                     <p className="text-sm text-center text-muted-foreground py-10">
                        No hay docentes con horas disponibles para este período y programa.
                    </p>
                )}
            </CardContent>
        </Card>

...
import { Home, Users, Building2, Inbox, GraduationCap, Briefcase, Palette } from 'lucide-react';
...
export function AppSidebarContents() {
  ...
  const superAdminItems = [
    ...
    { href: '/dashboard/superadmin/login-design', label: 'Diseño del Login', icon: Palette, roles: ['SuperAdmin'] },
  ];

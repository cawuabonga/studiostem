...
export function SyllabusPrintLayout({ institute, program, unit, teacher, syllabus, weeklyData, indicators, designOptions = defaultOptions }: SyllabusPrintLayoutProps) {
    ...
    return (
        <div className="printable-area space-y-4 text-xs bg-transparent">
            {/* Página 1: Carátula */}
            <div className="print-page-preview">
                <div className="page-break flex flex-col h-full items-center justify-center text-center p-4">
             ...
             <div className="print-page-preview">
                 <div className="page-break space-y-4 p-6">

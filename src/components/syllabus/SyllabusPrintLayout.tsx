...
const PageHeader = ({ institute }: { institute: Institute | null }) => (
    <div className="inst-header no-print-break">
...
const PageFooter = ({ unitName }: { unitName: string }) => (
    <div className="inst-footer no-print">
...
export function SyllabusPrintLayout({ 
    ...
    return (
        <div className="printable-area bg-white">
            ...
            <div className="page-break flex flex-col justify-between py-12 min-h-[280mm]">
                <div className="space-y-10 flex flex-col items-center w-full">
                    ...
                    <div className="border-y-4 border-black py-8 w-full text-center my-6 bg-gray-50">
                        <h2 className="text-[24pt] font-black tracking-[0.2em] text-black">
            ...
            <div className="page-break py-4 min-h-[280mm]">
                        ...
                        <table className="w-full border-collapse border-2 border-black">
                            <tbody className="text-[9.5pt]">
                                ...
                                <tr>
                                    ...
                                    <td className="p-3 border border-black text-black">
                                        {(unit.totalHours / (unit.totalWeeks || 16)).toFixed(0)} h/s (T: {unit.theoreticalHours}h / P: {unit.practicalHours}h) | 
            ...
            <div className="py-4">
                ...
                <h3 className="text-[13pt] font-black border-b-2 border-black pb-1 my-6 flex items-center gap-2 text-black">
                    <span className="bg-black text-white px-3 py-0.5 text-[10pt]">IV</span>
            ...
            {/* --- ÚLTIMA PÁGINA: METODOLOGÍA, EVALUACIÓN Y FIRMAS --- */}
            <div className="page-break-before py-6 min-h-[280mm]">
                <PageHeader institute={institute} />
                
                <div className="mt-8 space-y-10">
                    <section>
                        <h3 className="text-[13pt] font-black border-b-2 border-black pb-1 mb-6 flex items-center gap-2 text-black">
                            <span className="bg-black text-white px-3 py-0.5 text-[10pt]">V</span>
                            METODOLOGÍA Y EVALUACIÓN
                        </h3>
                        <div className="space-y-8 text-[10pt] text-black">
                            <div>
                                <h4 className="font-black mb-3 uppercase text-gray-800">5.1 Estrategias Metodológicas:</h4>
                                <div className="pl-6 text-justify leading-relaxed border-l-2 border-gray-100">
                                    {renderHtml(syllabus?.methodology)}
                                </div>
                            </div>
                            <div>
                                <h4 className="font-black mb-4 uppercase text-gray-800">5.2 Evaluación por Indicadores de Logro:</h4>
                                <table className="w-full border-collapse border-2 border-black">
                                    <thead>
                                        <tr className="bg-gray-100 uppercase text-black">
                                            <th className="border border-black p-3 text-left w-[60%]">INDICADOR DE LOGRO</th>
                                            <th className="border border-black p-3 text-center w-[20%]">TÉCNICA</th>
                                            <th className="border border-black p-3 text-center w-[20%]">INSTRUMENTO</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {indicators.length > 0 ? indicators.map(indicator => (
                                            <tr key={indicator.id}>
                                                <td className="border border-black p-3 italic leading-tight text-black">{indicator.description}</td>
                                                <td className="border border-black p-3 text-center text-black">Observación / Ejercicios</td>
                                                <td className="border border-black p-3 text-center text-black">Rúbrica / Cuestionario</td>
                                            </tr>
                                        )) : (
                                            <tr><td colSpan={3} className="border border-black p-6 text-center text-gray-400">No se han definido indicadores aún.</td></tr>
                                        )}
                                    </tbody>
                                </table>
                                <div className="mt-6 p-4 bg-gray-50 border-l-4 border-black text-[9pt] italic text-black">
                    ...
                    <section>
                        <h3 className="text-[13pt] font-black border-b-2 border-black pb-1 mb-4 flex items-center gap-2 text-black">
                            <span className="bg-black text-white px-3 py-0.5 text-[10pt]">VI</span>
                            RECURSOS Y BIBLIOGRAFÍA
                        </h3>
                        <div className="pl-6 space-y-4 text-[9.5pt] text-black">
                            <div className="bg-gray-50 p-6 border-2 border-dashed border-gray-300 font-mono leading-relaxed">
                                {renderHtml(syllabus?.bibliography || "No se ha especificado bibliografía.")}
                            </div>
                        </div>
                    </section>

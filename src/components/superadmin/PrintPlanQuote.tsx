...
const PageHeader = ({ design, pageNumber }: { design: LoginDesign | null, pageNumber: number }) => {
    ...
    return (
        <div className="absolute top-[10mm] left-[20mm] right-[20mm] border-b-2 border-black pb-4 flex items-center justify-between z-50">
...
/**
 * Pie de página Institucional - Se repite en cada hoja
 */
const PageFooter = ({ design }: { design: LoginDesign | null }) => {
    const platformTitle = design?.title || "STEM V2";
    return (
        <div className="absolute bottom-[10mm] left-[20mm] right-[20mm] pt-2 border-t border-slate-200 flex justify-between items-center z-50">
            <div className="text-left">
    ...
    return (
        <div className="quote-print-container bg-white text-black font-sans">
            ...
            <div className="a4-page">
                ...
                <div className="content-area text-center px-10">
            ...
            <div className="a4-page">
                ...
                <div className="content-area px-6">
                    ...
                    <div className="mt-24">
                        <div className="grid grid-cols-2 gap-24 text-center px-16">
